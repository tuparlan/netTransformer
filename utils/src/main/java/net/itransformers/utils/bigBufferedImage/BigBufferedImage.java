package net.itransformers.utils.bigBufferedImage;
...
public class BigBufferedImage extends BufferedImage {
    ...
    public BigBufferedImage(int width, int height, int typeIntRgb) {
        super(width,height,typeIntRgb);
//        try {
//            create(new File("tmp"),width,height,typeIntRgb);
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
    }
    ...
    public BigBufferedImage(ColorModel cm, WritableRaster raster, boolean isRasterPremultiplied, Hashtable<?, ?> properties) {
